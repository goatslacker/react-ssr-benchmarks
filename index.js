...
module.exports = (config) => {
  const options = Object.assign({
    // The default version of React and ReactDOMServer we pass into "tests"
    React: Reacts['15'].React,
    ReactDOMServer: Reacts['15'].ReactDOMServer,
  ...
  options.tests.forEach((test) => {
    ...
    const ReactDOMServer = options.ReactDOMServer
    const Component = options.getComponent(React)
